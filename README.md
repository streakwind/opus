...
- **Schedule** shows timed classes and study blocks. Enable Class time when editing a list, choose weekdays/time/length, and its due tasks and assessments appear inside that class block. Class times are configured by the user.
